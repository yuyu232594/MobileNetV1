...
vis=visdom.Visdom()
train_db=Iris('/Users/wenyu/Desktop/demo',64,128,'train')
validation_db=Iris('/Users/wenyu/Desktop/demo',64,128,'validation')
test_db=Iris('/Users/wenyu/Desktop/demo',64,128,'test')
...
def main():
    ...
    pretrained_dict = torch.load('/Users/wenyu/Desktop/TorchProject/MobileNet/tf_to_torch.pth')
